#ifndef UNION_WEIGHT_FULL_COMPRESSION_H
#define UNION_WEIGHT_FULL_COMPRESSION_H
...
class UnionWeightFullCompression : public UnionFind {
public:
  // Creates the partition {{0}, {1}, ..., {n-1}}
  UnionWeightFullCompression(int n) {
...
#endif // UNION_WEIGHT_FULL_COMPRESSION_H